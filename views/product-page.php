...
<!-- Mirrored from labartisan.net/demo/PoultryFarm/poultry-farm/product-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2023 16:31:27 GMT -->
<head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="../public/images/x-icon/01.png">
        ...
        <div class="mobile-menu transparent-header">
            <nav class="mobile-header">
                <div class="header-logo">
                    <a href="index.html"><img src="../public/assets/images/logo/01.png" alt="logo"></a>
                </div>
                    ...
                    <div class="mobile-menu-area-inner">
                        <ul class="lab-ul">
                            ...
                            <li class="active">
                                <a href="#0">Shop</a>
                                <ul class="lab-ul">
                                    <li class="active"><a href="product-page.html">Products Page</a></li>
                        ...
                        <div class="primary-menu">
                            <div class="main-area w-100">
                                <div class="main-menu d-flex flex-wrap align-items-center justify-content-between w-100">
                                    <div class="logo">
                                        <a href="index.html"><img src="../public/assets/images/logo/02.png" alt="logo"></a>
                                    </div>
                                    <ul class="lab-ul">
                                        <li class="active">
                                        ...
                                        <li>
                                            <a href="#0">Shop</a>
                                            <ul class="lab-ul">
                                                <li><a href="product-page.html" class="active">Products Page</a></li>
                                                <li><a href="product-single.html">Products Details</a></li>
                                                <li><a href="cart-page.html">Cart Page</a></li>
                                            </ul>
                                        </li>
        ...
        <section class="page-header bg_img padding-tb">
            ...
            <div class="container">
                <div class="page-header-content-area">
                    <h4 class="ph-title">Poultry Farm Products</h4>
                    <ul class="lab-ul">
                    ...
                    <div class="row justify-content-center">
                     ...
                     ?>
                                   ...
                                   <!-- <div class="col-lg-4 col-md-6 col-12">
                                        <div class="product-item">
                                            <div class="product-thumb">
                                                <img src="../public/assets/images/product/02.jpg" alt="shope">
                                                <div class="product-action-link">
                                                    <a href="../public/assets/images/product/02.jpg" data-rel="lightcase"><i
                                                            class="icofont-eye"></i></a>
                                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                                    <a href="#"><i class="icofont-cart-alt"></i></a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="product-item">
                                            <div class="product-thumb">
                                                <img src="../public/assets/images/product/03.jpg" alt="shope">
                                                <div class="product-action-link">
                                                    <a href="../public/assets/images/product/03.jpg" data-rel="lightcase"><i
                                                            class="icofont-eye"></i></a>
                                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                                    <a href="#"><i class="icofont-cart-alt"></i></a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="product-item">
                                            <div class="product-thumb">
                                                <img src="../public/assets/images/product/04.jpg" alt="shope">
                                                <div class="product-action-link">
                                                    <a href="../public/assets/images/product/04.jpg" data-rel="lightcase"><i
                                                            class="icofont-eye"></i></a>
                                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                                    <a href="#"><i class="icofont-cart-alt"></i></a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="product-item">
                                            <div class="product-thumb">
                                                <img src="../public/assets/images/product/05.jpg" alt="shope">
                                                <div class="product-action-link">
                                                    <a href="../public/assets/images/product/05.jpg" data-rel="lightcase"><i
                                                            class="icofont-eye"></i></a>
                                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                                    <a href="#"><i class="icofont-cart-alt"></i></a>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="product-item">
                                            <div class="product-thumb">
                                                <img src="../public/assets/images/product/06.jpg" alt="shope">
                                                <div class="product-action-link">
                                                    <a href="../public/assets/images/product/06.jpg" data-rel="lightcase"><i
                                                            class="icofont-eye"></i></a>
                                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                                    <a href="#"><i class="icofont-cart-alt"></i></a>
                                                </div>
								...
								<ul class="lab-ul footer-location">
									...
									<li>
										...
										<div class="content-part">
											...
											<p>(except public/assetsc holidays)</p>
										</div>
									</li>
									<li>
										<div class="icon-part">
...
<!-- Mirrored from labartisan.net/demo/PoultryFarm/poultry-farm/product-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2023 16:31:28 GMT -->
</html>