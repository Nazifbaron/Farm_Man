...
.wrapper {
    ...
    border-radius: 15px;
    box-shadow: 4px 4px 5px #cbced1, -4px -4px 5px #fff;
}
...
<div class="wrapper">
        ...
        <form method="post" action="../../model/logins.php">
            ...
            <button class="btn mt-3" type="submit" name="envoie">Envoyer</button><br><br>
        </form>
