...
<!-- Mirrored from labartisan.net/demo/PoultryFarm/poultry-farm/product-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Mar 2023 16:31:28 GMT -->
<head>
						...
						<ul class="lab-ul">
							...
							<li class="active">
								...
								<ul class="lab-ul">
									...
									<li class="active"><a href="product-single.html">Products Details</a></li>
								...
								<div class="main-menu d-flex flex-wrap align-items-center justify-content-between w-100">
									...
									<ul class="lab-ul">
										...
										<li>
											...
											<ul class="lab-ul">
												<li><a href="product-page.html">Products Page</a></li>
												<li><a href="product-single.html" class="active">Products Details</a></li>
												<li><a href="cart-page.html">Cart Page</a></li>
											</ul>
										</li>
										<li>
		...
		<section class="page-header bg_img padding-tb">
			...
			<div class="container">
				<div class="page-header-content-area">
					<h4 class="ph-title">Poultry Farm Products Details</h4>
					<ul class="lab-ul">
												...
												<div class="swiper-slide">
													<div class="shop-item">
														<div class="shop-thumb">
															<img src="../public/assets/images/product/single/top/01.png"
																alt="shop-single">
														</div>
													</div>
												</div>
										...
										<div class="swiper-container gallery-thumbs">
											<div class="swiper-wrapper">
												<div class="swiper-slide">
													<div class="shop-item">
														<div class="shop-thumb">
															<img src="../public/assets/images/product/01.jpg" alt="shop-single">
														</div>
													</div>
												</div>
												<div class="swiper-slide">
													<div class="shop-item">
														<div class="shop-thumb">
															<img src="../public/assets/images/product/02.jpg" alt="shop-single">
														</div>
													</div>
												</div>
												<div class="swiper-slide">
													<div class="shop-item">
														<div class="shop-thumb">
															<img src="../public/assets/images/product/03.jpg" alt="shop-single">
														</div>
													</div>
												</div>
												<div class="swiper-slide">
													<div class="shop-item">
														<div class="shop-thumb">
															<img src="../public/assets/images/product/04.jpg" alt="shop-single">
														</div>
													</div>
												</div>
												<div class="swiper-slide">
													<div class="shop-item">
														<div class="shop-thumb">
															<img src="../public/assets/images/product/05.jpg" alt="shop-single">
														</div>
													</div>
												</div>
											</div>
						...
						<div class="review">
							...
							<div class="review-content review-content-show">
								<div class="review-showing">
									<ul class="agri-ul content">
										<li>
											<div class="post-thumb">
												<img src="../public/assets/images/team/01.jpg" alt="shop">
											</div>
											<div class="post-content">
										...
										<li>
											<div class="post-thumb">
												<img src="../public/assets/images/team/02.jpg" alt="shop">
											</div>
											<div class="post-content">
												<div class="entry-meta">
													<div class="posted-on">
										...
										<li>
											<div class="post-thumb">
												<img src="../public/assets/images/team/03.jpg" alt="shop">
											</div>
											<div class="post-content">
												<div class="entry-meta">
													<div class="posted-on">
										...
										<li>
											<div class="post-thumb">
												<img src="../public/assets/images/team/04.jpg" alt="shop">
											</div>
											<div class="post-content">
												<div class="entry-meta">
													<div class="posted-on">
									...
									<div class="client-review">
										<div class="review-form">
											...
											<form action="https://labartisan.net/demo/PoultryFarm/poultry-farm/action" class="row">
								...
								<div class="description">
									...
									<div class="post-item">
										<div class="post-thumb">
											<img src="../public/assets/images/product/01.jpg" alt="shop">
										</div>
										<div class="post-content">
											<ul class="agri-ul">
												<li>
